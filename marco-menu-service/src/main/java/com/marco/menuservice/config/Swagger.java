 ...
 *  <li><a href="http://192.168.99.102{:portnumber}/{context path}/swagger-ui.html">Swagger Page for this project (replace the place holders)</a></li>
 * </ul>
 * 
 * @author msolina
 *
...
public class Swagger {
    ...
    public Docket swaggerConfiguration() {
        return new Docket(DocumentationType.SWAGGER_2).select()
            .apis(RequestHandlerSelectors.basePackage("com.marco.menuservice.controllers"))
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("Marco Menus service POC")
